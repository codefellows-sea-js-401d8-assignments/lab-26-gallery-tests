...
let testApp1 = angular.module('testApp1', []);
require('../app/components/lance-gallery')(testApp1);

describe('lance stephenson gallery components', function() {
  beforeEach(angular.mock.module('testApp1'));
  ...
  it('should list images', function() {
    let imageGallery = this.compile(require('./lance-test.html'))(this.scope);
    this.scope.$digest();
